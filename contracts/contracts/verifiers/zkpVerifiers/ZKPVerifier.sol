...
contract ZKPVerifier is IZKPVerifier, Ownable {
    ...
    function submitZKPResponse(
        ...
        _afterProofSubmit(requestId, inputs, requestQueries[requestId].publicInput, requestValidators[requestId]);
        return true;
    }
    ...
    function setZKPRequest(
        ...
        requestQueries[requestId].publicInput = query.publicInput;
